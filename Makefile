...
GOFLAGS := -tags ${BUILD_TAGS} -trimpath -ldflags "-s -w -E cpuinit -T $(TEXT_START) -R 0x1000 -X 'main.Console=${CONSOLE}' -X 'github.com/usbarmory/go-boot/cmd.CommandLine=${CMDLINE}'"
